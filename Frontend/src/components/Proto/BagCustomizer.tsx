...
// Definisikan bagian-bagian tas dengan tambahan Ikon SVG agar persis gambar
const BAG_PARTS = [
  { 
    id: "body", 
    name: "BODY",
          ...
          <div className="flex flex-col lg:flex-row bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden lg:h-[750px]">
            ...
            <div className="w-full lg:w-[55%] p-6 lg:p-10 border-b lg:border-b-0 lg:border-r border-gray-100 relative flex flex-col bg-[#f8f9fa] overflow-hidden">
              ...
              <div className="flex-grow flex flex-col items-center justify-center w-full relative z-10 pt-4">
                ...
                {activeView === "front" && (
                  <div className="w-full max-w-[420px] aspect-[4/5] relative">
                    <DynamicPart pov="Front" partName="tali" color={selections.tali} zIndex={10} />
                    <DynamicPart pov="Front" partName="telinga" color={selections.telinga} zIndex={20} />
                    <DynamicPart pov="Front" partName="body" color={selections.body} zIndex={30} />
                ...
                {activeView === "back" && (
                  <div className="w-full max-w-[420px] aspect-[4/5] relative">
                    <DynamicPart pov="Back" partName="tali" color={selections.tali} zIndex={10} />
                    <DynamicPart pov="Back" partName="telinga" color={selections.telinga} zIndex={30} />
                    <DynamicPart pov="Back" partName="body" color={selections.body} zIndex={20} />
                  </div>
                )}
                ...
                {activeView === "top" && (
                  <div className="w-full max-w-[420px] aspect-[4/5] relative">
                    <DynamicPart pov="Top" partName="tali" color={selections.tali} zIndex={10} />
                    <DynamicPart pov="Top" partName="telinga" color={selections.telinga} zIndex={30} />
                    <DynamicPart pov="Top" partName="body" color={selections.body} zIndex={20} />
                  </div>
                )}

                {/* --- 360 VIEW --- */}
                {activeView === "360" && (
                  <div className="w-full max-w-[400px] aspect-[4/5] relative flex flex-col items-center justify-center border-2 border-dashed border-blue-300 rounded-2xl bg-blue-50">
              ...
              <div className="mt-6 flex justify-center z-20 pb-2">
                {/* Container Luar (Pill shape dengan border) */}
                    ...
                    return (
                      <button
                        ...
                        className={`relative w-[65px] h-[65px] rounded-xl flex flex-col items-center justify-center transition-all bg-[#f8f9fa]
                          ${isActive 
                            ? "border-2 border-[#4154f1] ring-[3.5px] ring-[#e0e7ff] text-[#4154f1]" 
                            : "border border-[#cbd5e1] text-[#64748b] hover:border-[#94a3b8]"}
                        `}
                      >
                        {view.type === "icon" ? (
            ...
            <div className="w-full lg:w-[45%] flex flex-col h-full bg-white">
              ...
              {/* Bottom Section (Harga & Tombol CTA) */}
              <div className="px-8 lg:px-12 py-8 bg-white border-t border-gray-100 shadow-[0_-4px_10px_rgba(0,0,0,0.02)] mt-auto">
                ...
                {/* Tombol dengan warna biru khas NextMerce */}
