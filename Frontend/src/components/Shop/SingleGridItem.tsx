      ...
      <div className="relative overflow-hidden flex items-center justify-center rounded-[1.25rem] bg-white border border-[#E5D7C1] shadow-[0_10px_30px_-10px_rgba(45,26,17,0.06)] min-h-[260px] aspect-square mb-5 transition-all duration-[800ms] group-hover:shadow-[0_20px_40px_-15px_rgba(197,160,89,0.25)] group-hover:border-[#C5A059]/50">
        ...
        <div className="absolute left-0 bottom-0 translate-y-[150%] w-full flex items-center justify-center gap-3 pb-6 ease-[cubic-bezier(0.25,1,0.5,1)] duration-700 group-hover:translate-y-0 z-20 px-4">
          <button
            ...
            className="flex-grow max-w-[140px] flex items-center justify-center h-10 px-5 rounded-full shadow-[0_8px_20px_rgba(45,26,17,0.15)] backdrop-blur-md bg-white/85 border border-white/50 font-sans font-bold text-[10px] tracking-[0.15em] uppercase text-[#2D1A11] transition-all duration-300 hover:bg-[#2D1A11] hover:text-[#C5A059] hover:border-[#2D1A11] hover:-translate-y-1"
          >
            Kustomisasi
          </button>
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-full shadow-[0_8px_20px_rgba(45,26,17,0.15)] backdrop-blur-md bg-white/85 border border-white/50 text-[#2D1A11] transition-all duration-300 hover:bg-[#C5A059] hover:text-[#Fdfbf7] hover:border-[#C5A059] hover:-translate-y-1"
          >
