...
const handleItemToWishList = async () => {
  ...
  handleItemToWishList(); // ✅ cukup ini saja
            ...
            className={`flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-full shadow-[0_8px_20px_rgba(45,26,17,0.15)] backdrop-blur-md border transition-all duration-300 hover:-translate-y-1
              ${isWishlisted
                ? "bg-[#C5A059] border-[#C5A059] text-white"
                : "bg-white/85 border-white/50 text-[#2D1A11] hover:bg-[#C5A059] hover:text-[#Fdfbf7] hover:border-[#C5A059]"
              }`}
          >
