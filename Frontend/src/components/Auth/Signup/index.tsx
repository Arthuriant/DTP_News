              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-5">
                  ...
                  <input
                    ...
                    id="name"
                    required
                    value={name} // Hubungkan ke state
                    onChange={(e) => setName(e.target.value)} // Hubungkan ke state
                ...
                <div className="mb-5.5">
                  ...
                  <input
                    ...
                    id="re-type-password"
                    required
                    value={passwordConfirmation} // Hubungkan ke state
                    onChange={(e) => setPasswordConfirmation(e.target.value)} // Hubungkan ke state
