...
const BlogDetailsWithSidebar = () => {
  // Ambil data blog pertama untuk referensi (opsional)
  const featuredBlog = blogData[0]; // "Cara Merawat Tas Kulit Agar Awet dan Tetap Mengkilap"
          ...
          <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-12.5">
            ...
            <div className="lg:max-w-[750px] w-full">
              ...
              <div>
                ...
                <p>
                  Langkah pertama yang paling penting adalah membersihkan tas secara teratur. Gunakan kain lembut yang sedikit lembap untuk mengangkat debu dan kotoran. Hindari penggunaan tisu basah atau pembersih berbahan kimia keras karena dapat merusak lapisan kulit. Setelah dibersihkan, keringkan dengan kain kering dan biarkan di tempat yang tidak terkena sinar matahari langsung.
                </p>
                ...
                <div className="mt-7.5">
                  ...
                  <ul className="list-disc pl-6">
                    ...
                    <li>Gunakan conditioner khusus kulit setiap 3-6 bulan untuk menjaga kelembapan dan mencegah retak.</li>
