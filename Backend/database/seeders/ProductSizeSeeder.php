...
class ProductSizeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $sourcePath = database_path('seeders/Product_Dummy/size-guide');
        ...
        foreach ($sizes as $index => $size) {
            ...
            if (File::exists($sourceFile)) {
                ...
                $this->command->info("Gambar '{$size['img_file']}' berhasil disalin.");
            } else {
        ...
        $this->command->info('==== SEEDING SIZE SELESAI ====');
    }
}
